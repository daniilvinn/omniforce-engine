...
namespace Cursed {
	...
	class CURSED_API MouseMovedEvent : public Event {
	public:
	...
	class CURSED_API MouseButtonPressedEvent : public Event {
	public:
	...
	class CURSED_API MouseButtonReleasedEvent : public Event {
	public:
	...
	class CURSED_API MouseScrolledEvent : public Event {
	public:
