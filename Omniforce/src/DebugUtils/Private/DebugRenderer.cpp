...
namespace Omni {
	...
	DebugRenderer::DebugRenderer()
	{
		...
		auto icosphere_data = mesh_generator.GenerateIcosphere(0);
	...
	void DebugRenderer::RenderWireframeBox(const TRS& trs)
	{
