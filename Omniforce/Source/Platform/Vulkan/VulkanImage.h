...
namespace Omni {
	...
	public:
		...
		void SetLayout(Ref<DeviceCmdBuffer> cmd_buffer, ImageLayout new_layout, PipelineStage src_stage, PipelineStage dst_stage, BitMask src_access = 0, BitMask dst_access = 0) override;
